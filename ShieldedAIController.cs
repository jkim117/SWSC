...
public abstract class ShieldedAIController : AIController
{
    ...
    protected void OnShieldPower(float value)
    {
        if (ionStatus)
        {
            return;
    ...
    protected void OnDecreaseOverallPower()
    {
        if (ionStatus)
        {
            return;
    ...
    protected void OnShieldControls()
    {
    ...
    protected void OnShuntToLasers()
    {
    ...
    protected void OnShuntToShields()
    {
        float totalCurrentShield = forwardShieldHealth + forwardOverShieldHealth + rearShieldHealth + rearOverShieldHealth;
    ...
    protected void ShieldedAIFixedUpdate()
    {
        updateShieldCharge();
